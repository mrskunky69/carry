...
Citizen.CreateThread(function()
    local itemModels = {
        "p_crate02x", "p_chair_crate15x", "p_stoolfolding01x", "p_crate06x", "p_barrel05b", "p_tincan01x", "s_crateseat03x", "p_chair_crate02x",
            ...
            options = {
                {
                    ...
                    action = function(entity)
                        ...
                        DeleteEntity(entity)  -- Delete the existing entity
                        createAndPickupObject(model, coords)  -- Use the string model name
                    end,
...
-- Handle syncing of carried entities from other players
